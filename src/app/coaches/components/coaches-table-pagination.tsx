...
interface CoachesTablePaginationProps {
  pagination: {
    page: number
    limit: number
    totalItems: number
...
export const CoachesTablePagination = ({
  pagination,
  onPageChange,
  onPageSizeChange,
  isLoading = false,
}: CoachesTablePaginationProps) => {
    ...
    <div className='flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 px-2 py-2'>
      <div className='text-muted-foreground text-xs md:text-sm text-center md:text-left'>
        <span className='hidden sm:inline'>
          Showing {startItem} to {endItem} of {pagination.totalItems} coaches
        </span>
