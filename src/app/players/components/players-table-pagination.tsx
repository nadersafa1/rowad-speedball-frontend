...
interface PlayersTablePaginationProps {
  pagination: {
    page: number;
    limit: number;
    totalItems: number;
...
export const PlayersTablePagination = ({
  pagination,
  onPageChange,
  onPageSizeChange,
  isLoading = false,
}: PlayersTablePaginationProps) => {
    ...
    <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 px-2 py-2">
      ...
      <div className="text-muted-foreground text-xs md:text-sm text-center md:text-left">
        <span className="hidden sm:inline">
          Showing {startItem} to {endItem} of {pagination.totalItems} players
        </span>
