...
const TEAM_OPTIONS = [5, 9, 19, 33] as const
    ...
    <div className='min-h-screen bg-gradient-to-br from-background to-muted/30'>
      <div className='container mx-auto py-8 px-4'>
        ...
        <Card className='mb-8'>
          <CardHeader>
            <div className='flex items-center justify-between flex-wrap gap-2'>
              <div>
                ...
                <CardDescription>
                  {players.length}-team single elimination bracket (
                  {bracketSize}-slot bracket with {byeCount} BYEs)
                </CardDescription>
              </div>
          ...
          <CardContent>
            <BracketVisualization matches={matches} totalRounds={totalRounds} />
          </CardContent>
        </Card>
